...
* **Thành viên** – Những thành viên đang được kích hoạt quyền ứng dụng LadiWork trong tài khoản&#x20;

<figure><img src="../../.gitbook/assets/image (3).png" alt=""><figcaption></figcaption></figure>

Sau khi thiết lập các điều kiện và thành viên phân phối giao dịch/công việc, bạn nhập Tên cho phần quy tắc và bấm **Kích hoạt quy tắc**&#x20;

Cuối cùng bấm **Tạo quy tắc điều phối** để hoàn thiện việc thiết lập
...
* Nếu có nhiều hơn 1 thành viên được lựa chọn, LadiWork sẽ tự động điều phối đều các giao dịch đến tất cả các thành viên theo vòng tròn, thứ tự thành viên từ trên xuống dưới, trong danh sách thành viên&#x20;
